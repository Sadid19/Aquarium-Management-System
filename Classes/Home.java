...
public class Home extends JFrame implements ActionListener
{
	...
	//JButton(as Image)
        ImageIcon icon1 = new ImageIcon("Images/profile.png");
	    ...
	    ImageIcon icon11 = new ImageIcon("Images/logout.png");
    ...
    //About & contact
	   ...
	   b11.setFont(new Font("Segoe UI",Font.BOLD,15));
	   ...
	   /*b12 = new JButton("Chat");
	   b12.setFont(new Font("Segoe UI",Font.BOLD,15));
	   b12.setForeground(Color.BLUE);
	   b12.setBorder(null);
	   b12.setBounds(515,600,90,15);
